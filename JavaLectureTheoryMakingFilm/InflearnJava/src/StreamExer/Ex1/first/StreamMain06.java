...
public class StreamMain06 {
	...
	public static void main(String[] args) {
		...
		boolean b4 = Stream.of("samsung", "samsung", "samsung").allMatch(s -> s.startsWith("s"));
		...
		Integer reduce3 = Stream.of(3, 3, 3).reduce(1,  (x, y) -> x * y);
		...
		String[] strArray = new String[] {"한국", "한국", "대한민국", "미국", "미합중국", "중국", "중화민국"};

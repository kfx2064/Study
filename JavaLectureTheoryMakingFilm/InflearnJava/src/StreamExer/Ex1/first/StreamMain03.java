...
public class StreamMain03 {
	...
	public static void main(String[] args) {
		...
		Stream<String> strStream03 = 
				Stream.of("b", "c", "a").sorted((i1, i2) -> i1.compareTo(i2));
		strStream03.forEach(i -> System.out.print(i + " "));
		System.out.println();
		
		Stream<String> strStream04 = 
				Stream.of("b", "c", "a").sorted(String::compareTo);
		strStream04.forEach(i -> System.out.print(i + " "));
		System.out.println(); 
		
		System.out.println("===============================================");
		
		Stream<String> reverseStream01 =
				Stream.of("b", "c", "a").sorted(Comparator.reverseOrder());
		...
		Stream<String> caseStream06 = caseStream06 = Stream.of("b", "cc", "A", "A", "B").sorted(Comparator.comparing(i -> i.length()));
		caseStream06.forEach(i -> System.out.print(i + " "));
		System.out.println();
		
		Stream<String> caseStream07 = Stream.of("b", "cc", "A", "A", "B").sorted(Comparator.comparing(String::length).reversed());

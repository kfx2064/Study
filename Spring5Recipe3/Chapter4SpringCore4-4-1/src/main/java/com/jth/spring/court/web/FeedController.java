...
import com.jth.spring.court.feeds.TournamentContent;
...
public class FeedController {
	...
	public String getAtomFeed(Model model) {
		...
		tournamentList.add(TournamentContent.of("ATP", new Date(), "Australian Open", "www.austrailianopen.com"));
	...
	public String getJSON(Model model) {
		List<TournamentContent> tournamentList = new ArrayList<>();
		tournamentList.add(TournamentContent.of("FIFA", new Date(), "", ""));
		tournamentList.add(TournamentContent.of("FIFA", new Date(), "", ""));
		tournamentList.add(TournamentContent.of("FIFA", new Date(), "", ""));
		tournamentList.add(TournamentContent.of("FIFA", new Date(), "", ""));
		model.addAttribute("feedContent", tournamentList);

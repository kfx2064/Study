...
<form:form modelAttribute="member" method="post" action="register">
    <table>
        <tr>
            <td>개발자여부</td>
            <td>
                <input id="developer1" name="developer" type="checkbox" value="Y"/>
        ...
        <tr>
            <td>외국인여부</td>
            <td>
                <input id="foreigner1" name="foreigner" type="checkbox" value="true" />
        ...
        <tr>
            ...
            <td>
                ...
                <input type="hidden" name="_hobby" value="on" /><br>
                <input id="hobby3" name="hobby" type="checkbox" value="Movie" />
        ...
        <tr>
            ...
            <td>
                ...
                <input id="hobbyArray2" name="hobbyArray" type="checkbox" value="Music" />
                <label for="hobbyArray2"> Music</label>
                <input type="hidden" name="_hobbyArray" value="on" />
                <input id="hobbyArray3" name="hobbyArray" type="checkbox" value="Movie" />
        ...
        <tr>
            ...
            <td>
                ...
                <input type="hidden" name="_hobbyList" value="on" /><br>
                <input id="hobbyList3" name="hobbyList" type="checkbox" value="Movie" />

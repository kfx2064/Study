...
public class Boot03ApplicationTests {
	...
	*/
	...
	public void testBnoPagingSort() {
		...
		list.forEach(board -> System.out.println("testBnoPagingSort : " + board));
	...
	public void testBnoPagingSort() {
		...
		results.forEach(board -> System.out.println("testBnoPagingSort : " + board));
	...
	public void testBnoOrderByPaging() {
		...
		results.forEach(board -> System.out.println("testBnoOrderByPaging : " + board));
	...
	public void testBnoOrderBy() {
		...
		results.forEach(board -> System.out.println("testBnoOrderBy : " + board));
	...
	public void testByTitleAndBno() {
		...
		Collection<Board> results = repo.findByTitleContainingAndBnoGreaterThan("5", 40L);
		
		results.forEach(board -> System.out.println("titleContainingAndBnoGreaterThan : " + board));
